...
// DATABASE_URL looks like 'postgres://user:pass@host:port/database'
const DATABASE_URL = process.env.DATABASE_URL;
const connectionString = DATABASE_URL.split('/').slice(0, -1).join('');
const database = DATABASE_URL.split('/').slice(-1)[0];
